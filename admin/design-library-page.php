						...
						<div class="wetravel-trips-design-card">
							...
							<div class="wetravel-trips-design-info">
								...
								<div class="wetravel-trips-design-actions">
									...
									<button class="button button-small wetravel-trips-copy-shortcode" data-shortcode='[wetravel_trips design="<?php echo esc_attr( empty( $design['keyword'] ) ? $design_id : $design['keyword'] ); ?>"]'>Copy Shortcode</button>
								</div>
							</div>
						</div>
					<?php endforeach; ?>
